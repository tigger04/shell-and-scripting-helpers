# wraps github emoji shortcodes to bash variables in an assoc array, so you can do
# 
# `echo ${moji[grinning_face]}`
# 
# with the function at the end you can also do:
# 
# `moji[grinning_face]`
# 
# etc

if [ -n "${moji[upside_down_face]}" ]; then
# if these have already been defined, e.g. this file was sourced more than once,
